          ...
          <h1 style="flex-shrink: 0">Settings</h1>
            ...
            <div class={styles.bottomMenu}>
              <Show when={hasAdvanced$()}>
                  <div class={styles.advancedRow} onClick={() => setAdvanced(!showAdvanced$())} use:focusable={{ 
                    ...
                    <div style="line-height: 33px; font-size: 16px; color: #999; margin-left: 3px;">
                      Advanced
                    </div>
