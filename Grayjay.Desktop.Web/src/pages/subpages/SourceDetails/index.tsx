      ...
      <div style="height: 100%; display: flex; flex-direction: column;">
        ...
        <div class={styles.settings}>
          <Show when={sourceResource$()?.hasUpdate}>
            <Button style={{ width: "calc(100% - 30px)", height: "48px", "margin-bottom": "10px" }} text='Update' hoverColor='#2E2E2E' textColor='#fff' hoverTextColor='#fff' onClick={() => reinstallFromRemote()} focusableOpts={{
          ...
          <Show when={!!sourceResource$()?.config?.authentication}>
            <Show when={!sourceResource$()?.hasLoggedIn}>
              ...
              <Show when={StateGlobal.settings$()?.object?.info?.mode != "Server"}>
                <Button style={{ width: "calc(100% - 30px)", height: "48px", "margin-bottom": "10px", display: "flex", "justify-content": "center", "align-items": "center" }} text='Login' hoverColor='#2E2E2E' textColor='#fff' hoverTextColor='#fff' onClick={() => login(sourceResource$()!.config.id)} focusableOpts={{
                  groupId: 'plugin-settings',
                  groupEscapeTo: {
                    left: ['sources']
                  },
          ...
          <ScrollContainer ref={scrollContainerRef} wrapperStyle={{ "flex-grow": 1, "width": "100%" }}>
            ...
            <Button style={{ width: "calc(100% - 54px)", height: "48px", "margin-bottom": "10px", "margin-left": "24px" }} text='Uninstall' color='#550000' hoverColor='#FF5A5A' textColor='#fff' hoverTextColor='#fff' onClick={() => uninstall()} focusableOpts={{
              groupId: 'plugin-settings',
              groupEscapeTo: {
                left: ['sources']
              },
            ...
            <Button style={{ width: "calc(100% - 54px)", height: "48px", "margin-bottom": "10px", "margin-left": "24px" }} text='Copy Settings to Clipboard' color='transparent' hoverColor='transparent' textColor='#0182E7' hoverTextColor='#1A9EEF' focusColor='#fff' focusTextColor='#141414' onClick={() => copySettingsToClipboard()} focusableOpts={{
              groupId: 'plugin-settings',
              groupEscapeTo: {
                left: ['sources']
              },
